...
import 'package:money_library_2021/models/position.dart';
import 'package:money_library_2021/models/project.dart';
...
class StorageBloc {
  ...
  Future<String> uploadPhotoOrVideo(
    ...
    var name = 'media@${project.projectId}@' +
        ...
        '.${isVideo ? 'mp4' : 'jpg'}';
    try {
      p('☕️☕️☕️ .uploadPhoto ------------ ..... ☕️ path: ${file.path}');
      ...
      // uploadTask.future.whenComplete(() => null).then((snapShot) async {
      //   var totalByteCount = snapShot.;
