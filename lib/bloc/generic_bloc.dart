...
import 'package:money_library_2021/api/data_api.dart';
import 'package:money_library_2021/api/db.dart';
import 'package:money_library_2021/api/list_api.dart';
import 'package:money_library_2021/api/maker.dart';
...
class GenericBloc {
  GenericBloc() {
    print(
        '🅿️ 🅿️   🎽 🎽 🎽 🎽 ......... GenericBloc constructor .............. 🎽 🎽 🎽 🎽  🅿️ 🅿️ ');
    getCachedMember();
  }
...
//    print('💚 💚 sendInvitationViaWhatsapp: whatsapp message sent to 🍊 ${invitation.cellphone}');
  ...
  Future<Member> getCachedMember() async {
    ...
    if (_member.stokvelIds.isNotEmpty) {
      ...
      print(
          '............ This member has NO stokvels, 👿 👿 👿 what the fuck? 👿 👿 👿 ');
    }
    return _member;
  }

  Future<bool> isAuthenticated() async {
    return await Auth.checkAuthenticated();
  }
  ...
  Future<List<MemberPayment>> refreshMemberPaymentsReceived(
  ...
  Future subscribeToFCM() async {
    ...
    print(
        '💜 GenericBloc: 💜 💜 Subscribing to FCM topics for member: 🍎 ${_member.name} 🍎 with ${_member.stokvelIds.length} stokvels 💜 💜 ');
