...
import 'package:money_library_2021/bloc/generic_bloc.dart';
import 'package:money_library_2021/models/stokvel.dart';
import 'package:money_library_2021/ui/picture_grid.dart';
import 'package:money_library_2021/util/functions.dart';
import 'package:money_library_2021/util/slide_right.dart';
...
class StokvelGoalList extends StatefulWidget {
  ...
  const StokvelGoalList({Key key, this.returnStokvelGoalOnTap})
      : super(key: key);
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        '${_member == null ? '0' : _member.stokvelIds.length}',
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    '${goal.imageUrls.length}',
                                    style: Styles.blackBoldSmall,
                                  ),
                                  SizedBox(
                                    width: 20,
                                  ),
                                  goal.imageUrls.isEmpty
                                      ? Container()
                                      : FlatButton(
                                          onPressed: () {
                                            Navigator.push(
