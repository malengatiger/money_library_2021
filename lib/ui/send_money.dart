...
import 'package:money_library_2021/ui/scan/payment_scan.dart';
import 'package:money_library_2021/ui/stokvel_goal_list.dart';
  ...
  _displayNoStokvelDialog() {
    showDialog(
        ...
        builder: (_) => new AlertDialog(
              title:
                  new Text("Group Unavailable", style: Styles.blackBoldMedium),
              content: Container(
                height: 200.0,
                child: Column(
                  children: <Widget>[
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
            ...
            preferredSize: Size.fromHeight(
                isStokvelPayment ? getStokvelSize() : getMemberSize())),
      ),
