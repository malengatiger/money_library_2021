...
class CloudStorageBloc {
  ...
  //   print(
  //       '🌼🌼 CloudStorageBlocL uploadFile: 🌼 ${file.path} ... starting upload ....');
  //   assert(file != null);
  ...
  //   print(
  //       '🌼🌼 CloudStorageBlocL uploadFile: 🌼 ... starting storageReference.putFile(file) ....isSignedIn: $isSignedIn');
  ...
  //   print(
  //       '🦠 🦠 🦠 StorageUploadTask returning url after put in stream: 🔵 🔵 🔵 $url');
  //   return url;
  // }
